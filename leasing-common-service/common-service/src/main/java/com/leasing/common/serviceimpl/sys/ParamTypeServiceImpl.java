...
public class ParamTypeServiceImpl implements ParamTypeService {
    ...
    @Override
    public List<ParameterVO> findByParamTypeAndParamValue(Integer paramType, String paramValue) {
        return paramTypeRepo.findByParamTypeAndParamValue(paramType, paramValue);
    }

    @Override
    public List<ParameterVO> findByTypeWithCodeOrName(Integer paramType, String paramValue) {
        return paramTypeRepo.findByTypeWithCodeOrName(paramType, paramValue);
    }
}
