...
public class StringUtils {
    ...
    public static int indexOf(String str, String searchStr, int startPos) {
        return str != null && searchStr != null ? (searchStr.length() == 0 && startPos >= str.length() ? str.length()
                : str.indexOf(searchStr, startPos)) : -1;
    }
    ...
    public static int indexOfAnyBut(String str, char[] searchChars) {
        if (!isEmpty(str) && !ArrayUtils.isEmpty(searchChars)) {
            label27: for (int i = 0; i < str.length(); ++i) {
                char ch = str.charAt(i);
    ...
    public static boolean containsOnly(String str, char[] valid) {
        return valid != null && str != null
                ? (str.length() == 0 ? true : (valid.length == 0 ? false : indexOfAnyBut(str, valid) == -1)) : false;
    }
    ...
    public static int lastIndexOfAny(String str, String[] searchStrs) {
        if (str != null && searchStrs != null) {
            ...
            for (int i = 0; i < sz; ++i) {
                String search = searchStrs[i];
                if (search != null) {
                    int arg6 = str.lastIndexOf(search);
                    if (arg6 > ret) {
                        ret = arg6;
                    }
                }
    ...
    public static String removeStart(String str, String remove) {
        return !isEmpty(str) && !isEmpty(remove) ? (str.startsWith(remove) ? str.substring(remove.length()) : str)
                : str;
    }

    public static String removeStartIgnoreCase(String str, String remove) {
        return !isEmpty(str) && !isEmpty(remove)
                ? (startsWithIgnoreCase(str, remove) ? str.substring(remove.length()) : str) : str;
    }

    public static String removeEnd(String str, String remove) {
        return !isEmpty(str) && !isEmpty(remove)
                ? (str.endsWith(remove) ? str.substring(0, str.length() - remove.length()) : str) : str;
    }

    public static String removeEndIgnoreCase(String str, String remove) {
        return !isEmpty(str) && !isEmpty(remove)
                ? (endsWithIgnoreCase(str, remove) ? str.substring(0, str.length() - remove.length()) : str) : str;
    }
            ...
            if (timeToLive < 0) {
                ...
                if (searchLength != replacementLength) {
                    ...
                    for (start = 0; start < searchLength; ++start) {
                        if (!noMoreMatchesForReplIndex[start] && searchList[start] != null
                                && searchList[start].length() != 0 && replacementList[start] != null) {
                            arg15 = text.indexOf(searchList[start]);
                            if (arg15 == -1) {
                                noMoreMatchesForReplIndex[start] = true;
                            } else if (textIndex == -1 || arg15 < textIndex) {
                                textIndex = arg15;
                                replaceIndex = start;
                            }
                        }
                    ...
                    if (textIndex == -1) {
                        ...
                        StringBuffer arg16 = new StringBuffer(text.length() + increase);

                        while (textIndex != -1) {
                            for (textLength = start; textLength < textIndex; ++textLength) {
                                arg16.append(text.charAt(textLength));
                            }

                            arg16.append(replacementList[replaceIndex]);
                            ...
                            for (textLength = 0; textLength < searchLength; ++textLength) {
                                if (!noMoreMatchesForReplIndex[textLength] && searchList[textLength] != null
                                        && searchList[textLength].length() != 0
                                        && replacementList[textLength] != null) {
                                    arg15 = text.indexOf(searchList[textLength], start);
                                    if (arg15 == -1) {
                        ...
                        for (int result = start; result < textLength; ++result) {
                            arg16.append(text.charAt(result));
                        }

                        String arg17 = arg16.toString();
                        if (!repeat) {
                            return arg17;
                        } else {
                            return replaceEach(arg17, searchList, replacementList, repeat, timeToLive - 1);
                        }
                    }
                }
            }
    ...
    public static String chomp(String str) {
        if (isEmpty(str)) {
            ...
            char arg2 = str.charAt(0);
            return arg2 != 13 && arg2 != 10 ? str : "";
        } else {
    ...
    public static String chomp(String str, String separator) {
        return !isEmpty(str) && separator != null
                ? (str.endsWith(separator) ? str.substring(0, str.length() - separator.length()) : str) : str;
    }
                ...
                if (inputLength == 1 && repeat <= 8192) {
                    ...
                    switch (inputLength) {
                        case 1:
                            ...
                            for (int arg10 = repeat - 1; arg10 >= 0; --arg10) {
                                output1[arg10] = ch;
                            }
                        ...
                        default:
                            StringBuffer arg11 = new StringBuffer(outputLength);
    ...
    public static String rightPad(String str, int size, char padChar) {
        if (str == null) {
            ...
            return pads <= 0 ? str
                    : (pads > 8192 ? rightPad(str, size, String.valueOf(padChar)) : str.concat(padding(pads, padChar)));
        }
    }
    ...
    public static String leftPad(String str, int size, char padChar) {
        if (str == null) {
            ...
            int pads = size - str.length();
            return pads <= 0 ? str
                    : (pads > 8192 ? leftPad(str, size, String.valueOf(padChar)) : padding(pads, padChar).concat(str));
        }
    }
    ...
    public static String swapCase(String str) {
        ...
        if (str != null && (strLen = str.length()) != 0) {
            ...
            for (int i = 0; i < strLen; ++i) {
                char arg4 = str.charAt(i);
                if (Character.isUpperCase(arg4)) {
                    arg4 = Character.toLowerCase(arg4);
                } else if (Character.isTitleCase(arg4)) {
                    arg4 = Character.toLowerCase(arg4);
                } else if (Character.isLowerCase(arg4)) {
                    arg4 = Character.toUpperCase(arg4);
                }
    ...
    public static String abbreviate(String str, int offset, int maxWidth) {
        if (str == null) {
            ...
            if (offset <= 4) {
                ...
                return offset + (maxWidth - 3) < str.length() ? "..." + abbreviate(str.substring(offset), maxWidth - 3)
    ...
    public static String getCommonPrefix(String[] strs) {
        if (strs != null && strs.length != 0) {
            ...
            return smallestIndexOfDiff == -1 ? (strs[0] == null ? "" : strs[0])
                    : (smallestIndexOfDiff == 0 ? "" : strs[0].substring(0, smallestIndexOfDiff));
        } else {
            return "";
        }
    }
    ...
    public static int getLevenshteinDistance(String s, String t) {
        if (s != null && t != null) {
            ...
            if (n == 0) {
                ...
                int[] arg10 = new int[n + 1];
                int[] d = new int[n + 1];

                int i;
                for (i = 0; i <= n; arg10[i] = i++) {
                    ;
                }
                ...
                for (int j = 1; j <= m; ++j) {
                    ...
                    for (i = 1; i <= n; ++i) {
                        ...
                        d[i] = Math.min(Math.min(d[i - 1] + 1, arg10[i] + 1), arg10[i - 1] + cost);
                    }
    ...
    private static boolean startsWith(String str, String prefix, boolean ignoreCase) {
        return str != null && prefix != null ? (prefix.length() > str.length() ? false
                : str.regionMatches(ignoreCase, 0, prefix, 0, prefix.length())) : str == null && prefix == null;
    }
