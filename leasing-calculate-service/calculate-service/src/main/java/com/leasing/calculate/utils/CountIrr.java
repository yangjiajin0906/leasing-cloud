...
import com.leasing.calculate.Enum.Days360;
import com.leasing.calculate.Enum.ParamConst;
import com.leasing.calculate.Enum.Year_Days_Irr;
import com.leasing.calculate.Enum.Year_Days_Value;
...
//      double end = 0.125;
        ...
        if (maxKey <= 32) {
            ...
            throw new BusinessException("超出irr计算范围");
        }
        begin = begin / flag;
        end = end / flag;
...
//      double end = 0.125;
    ...
    public static BigDecimal calirr(BigDecimal flowcash,BigDecimal diffvalue) {
       ...
       /* 2032-9-21   -3561372.22
        ...
        if(currflowcash.subtract(calflowcash).abs().compareTo(new BigDecimal(0.01))>0){
