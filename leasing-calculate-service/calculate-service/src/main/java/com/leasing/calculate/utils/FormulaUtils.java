...
//    static {
//        try {
//            ruledoc = ConfigFactory.getXmlConfig("billdef/rule/rule.xml");
//            // ruledoc = XMLUtils.getDocumentBuilder().parse(
//            // FormulaUtils.class
//            // .getResourceAsStream("/billdef/rule/rule.xml"));
//        } catch (Exception e) {
            ...
            if (st.equals(" 如果 ".trim())) {
                ...
                if (isSpecialChar(st) || map.get(st) != null || map.values().contains(st)) {
                    ...
                    try {
                        ...
                        //throw new BusinessException("不认识的： " + st + " ！");
                        // return null;
                    }
                }
            }
