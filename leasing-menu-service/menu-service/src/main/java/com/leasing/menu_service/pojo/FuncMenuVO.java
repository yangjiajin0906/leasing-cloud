package com.leasing.menu_service.pojo;
...
public class FuncMenuVO {
    ...
    //子菜单
    private List<FuncMenuVO> children;
    //图标
    private String icon;
    //来源系统
    ...
    public List<FuncMenuVO> getChildren() {
        return children;
    }

    public void setChildren(List<FuncMenuVO> children) {
