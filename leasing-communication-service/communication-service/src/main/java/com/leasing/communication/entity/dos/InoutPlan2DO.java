...
public class InoutPlan2DO extends FileBaseBusinessDO {
    /**
     * 租金计划主键
     */
    @Id
    ...
    public InoutPlan2DO(String pkInoutPlan, String contCode, Integer leaseType, Integer rentEventType, Integer planLeaseTime, String planDate, BigDecimal planAmount, BigDecimal planLeaseCorpus, BigDecimal planInterest, String datePaidin, BigDecimal amountPaidin, BigDecimal corpusPaidin, BigDecimal interestPaidin, BigDecimal amountBalance, BigDecimal corpusBalance, String pkCurrency) {
