...
public class CbCapitalDetailImpDTO {
     ...
     * 事件类别
     */
    @Excel(titleName = "事件类别", orderNum = 6)
    private String eventType;

    /**
     * 期次
     */
    @Excel(titleName = "期次", orderNum = 7)
    private Integer periodTime;

    /**
     * 应收日期
     */
    @Excel(titleName = "应收日期", orderNum = 8)
    private String receivableDate;

    /**
     * 应收金额
     */
    @Excel(titleName = "应收金额", orderNum = 9)
     ...
     * 应收利息
     */
    @Excel(titleName = "应收利息", orderNum = 11)
     ...
     * 到账金额
     */
    @Excel(titleName = "到账金额", orderNum = 13)
    private BigDecimal intoAccountAmount;

    /**
     * 到账日期
     */
    @Excel(titleName = "到账日期", orderNum = 14)
    private String intoAccountDate;
    /**
     * 核销状态
     */
    @Excel(titleName = "核销状态", orderNum = 15)
    private Integer verificationState;

    /**
     * 核销日期
     */
    @Excel(titleName = "核销日期", orderNum = 16)
    private String verificationDate;

    /**
     * 是否逾期
     */
    @Excel(titleName = "是否逾期", orderNum = 17)
    private Integer ifOverdue;

    /**
     * 抵扣状态
     */
    @Excel(titleName = "抵扣状态", orderNum = 18)
    private Integer deductionStatus;

    /**
     * 抵扣日期
     */
    @Excel(titleName = "抵扣日期", orderNum = 19)
    private String deductionDate;

    /**
     * 收款银行
     */
    @Excel(titleName = "收款银行", orderNum = 20)
    private String gatherBank;

    /**
     * 收款账号
     */
    @Excel(titleName = "收款账号", orderNum = 21)
    private String gatherAccount;

    /**
     * 核销金额
     */
    @Excel(titleName = "核销金额", orderNum = 22)
    private BigDecimal gatherBalance;

    /**
     * 实收本金
     */
    @Excel(titleName = "实收本金", orderNum = 23)
    private BigDecimal paidinCorpus;

    /**
     * 实收利息
     */
    @Excel(titleName = "实收利息", orderNum = 24)
     ...
     * 来源系统
     */
    @Excel(titleName = "来源系统", orderNum = 27)
